...
SECRET_KEY = os.getenv('SECRET_KEY', 'pineapples')
...
# Third-party apps used by this project (auth / API)
INSTALLED_APPS += [
    ...
    # optional: blacklist support for SimpleJWT
...
# Use Heroku's Postgres database if DATABASE_URL is set
...
# Allauth settings
ACCOUNT_EMAIL_VERIFICATION = 'none'  # Turn off email verification
